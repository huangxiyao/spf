...
##      /opt/sasuapps/sp/domain/spfB/servers/spfB1/resources
##      /opt/sasuapps/sp/domain/spfB/servers/spfB2/resources
##   LOG FILE LOCATIONS:
##      /opt/sasuapps/sp/vignetteSPFB/portal742/logs
##      /opt/sasuapps/sp/domain/spfB/servers/spfB1/logs
##      /opt/sasuapps/sp/domain/spfB/servers/spfB2/logs
##################################################################################
''
end-of-message
...
eval "${run_access_script}" ssh -t g1u1698.austin.hp.com "$@"

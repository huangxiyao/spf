 ...
 * clear text form of a given encrypted HPP admin password. 
 * 
 * @author akashs
 *
 */
public class HPPAdminPasswordDecryptor {
	private static final String DEFAULT_LOC_OF_KEY_FILE = "/com/hp/spp/hpp/admin/keyfile";
	
	private static final void  printUsage(){
		System.out.println("Usage: java HPPAdminPasswordDecryptor <Encrypted admin password> <optional location of the secret key file>");
		System.out.println("The 'encrypted admin password' is required and must not be null.");
	 ...
	 * 
	 */
	public HPPAdminPasswordDecryptor() {
		super();
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(adminUtil.decryptPassword(args[0]));
			
		}catch (Exception e) {
			System.out.println("A problem occured while decrypting the password");

<%@ page contentType="text/html;charset=UTF-8" %><%
	if ("POST".equals(request.getMethod())) {
		...
		if (xml == null) {
			...
			com.hp.spp.wsrp.export.WsrpProducerPreferenceImport preferenceImport = new com.hp.spp.wsrp.export.WsrpProducerPreferenceImport();
			preferenceImport.importPreferences(xml, out);
		}
	}
	else {
%>
<html>
<head>
	<title>WSRP preference import</title>
</head>
<body>
<form method="POST">

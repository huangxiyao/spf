...
public class ActionClass extends AbstractComponentElement {

	public static final String DESCRIPTOR = "class" ;
...
//	}
	...
	ActionClass(Node node) throws ComponentException, BadConstructorException {
		if(node == null)

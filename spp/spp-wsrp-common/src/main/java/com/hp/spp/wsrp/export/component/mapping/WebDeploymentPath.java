...
public class WebDeploymentPath extends AbstractComponentElement {

	public static final String DESCRIPTOR = "web-deployment-path" ;
...
//	public WebDeploymentPath() {
//		
//	}

	WebDeploymentPath(Node node) throws ComponentException, BadConstructorException {
		if(node == null)

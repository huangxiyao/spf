...
public class LocaleKey extends AbstractComponentElement {

	public static final String DESCRIPTOR = "locale-key" ;
...
//	}
	...
	LocaleKey(Node node) throws ComponentException, BadConstructorException {
		if(node == null)

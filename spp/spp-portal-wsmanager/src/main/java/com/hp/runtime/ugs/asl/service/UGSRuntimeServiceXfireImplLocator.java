...
public class UGSRuntimeServiceXfireImplLocator extends org.apache.axis.client.Service implements com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImpl {
    ...
    public com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplPortType getUGSRuntimeServiceXfireImplHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplPortType getUGSRuntimeServiceXfireImplHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplHttpBindingStub _stub = new com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplHttpBindingStub _stub = new com.hp.runtime.ugs.asl.service.UGSRuntimeServiceXfireImplHttpBindingStub(new java.net.URL(UGSRuntimeServiceXfireImplHttpPort_address), this);
                _stub.setPortName(getUGSRuntimeServiceXfireImplHttpPortWSDDServiceName());
                return _stub;
            }
        }

...
public class GroupRequest  implements java.io.Serializable {
    ...
    private com.hp.runtime.ugs.asl.service.UserContext[] userContext;
    ...
    public GroupRequest(
           ...
           com.hp.runtime.ugs.asl.service.UserContext[] userContext) {
     ...
     * @return userContext
     */
    public com.hp.runtime.ugs.asl.service.UserContext[] getUserContext() {
        return userContext;
    }
     ...
     * @param userContext
     */
    public void setUserContext(com.hp.runtime.ugs.asl.service.UserContext[] userContext) {
        this.userContext = userContext;
    }

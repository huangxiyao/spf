 ...
 * Schema.
 * $Id: ChangeUserIdResultType.java,v 1.1 2006/09/08 14:31:58 geymonda Exp $
 */
...
/**
 * Class ChangeUserIdResultType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:58 $
 */
public class ChangeUserIdResultType implements java.io.Serializable {
    ...
    public ChangeUserIdResultType() 
     {
        super();
    } //-- com.hp.globalops.hppcbl.webservice.ChangeUserIdResultType()

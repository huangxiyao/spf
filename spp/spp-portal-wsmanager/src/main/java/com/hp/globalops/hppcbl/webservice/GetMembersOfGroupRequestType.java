 ...
 * Schema.
 * $Id: GetMembersOfGroupRequestType.java,v 1.1 2006/09/08 14:31:57 geymonda Exp $
 */
...
/**
 * Class GetMembersOfGroupRequestType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:57 $
 */
public class GetMembersOfGroupRequestType implements java.io.Serializable {
    ...
    public GetMembersOfGroupRequestType() 
     {
        super();
    } //-- com.hp.globalops.hppcbl.webservice.GetMembersOfGroupRequestType()

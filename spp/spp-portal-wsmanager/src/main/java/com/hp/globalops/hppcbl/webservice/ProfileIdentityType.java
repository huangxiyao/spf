 ...
 * Schema.
 * $Id: ProfileIdentityType.java,v 1.1 2006/09/08 14:32:06 geymonda Exp $
 */
...
/**
 * Class ProfileIdentityType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:06 $
 */
public class ProfileIdentityType implements java.io.Serializable {
    ...
    public ProfileIdentityType() 
     {
        super();
    } //-- com.hp.globalops.hppcbl.webservice.ProfileIdentityType()

 ...
 * Schema.
 * $Id: AddUserToGroupRequestType.java,v 1.1 2006/09/08 14:31:55 geymonda Exp $
 */
...
/**
 * Class AddUserToGroupRequestType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:55 $
 */
public class AddUserToGroupRequestType implements java.io.Serializable {
    ...
    public AddUserToGroupRequestType() 
     {
        super();
        _emailTemplateList = new Vector();
    } //-- com.hp.globalops.hppcbl.webservice.AddUserToGroupRequestType()

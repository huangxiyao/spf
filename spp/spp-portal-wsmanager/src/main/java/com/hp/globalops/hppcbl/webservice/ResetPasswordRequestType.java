 ...
 * Schema.
 * $Id: ResetPasswordRequestType.java,v 1.1 2006/09/08 14:32:10 geymonda Exp $
 */
 ...
 */
public class ResetPasswordRequestType implements java.io.Serializable {
    ...
    public ResetPasswordRequestType() 
     {
        super();
        _emailTemplateList = new Vector();
    } //-- com.hp.globalops.hppcbl.webservice.ResetPasswordRequestType()

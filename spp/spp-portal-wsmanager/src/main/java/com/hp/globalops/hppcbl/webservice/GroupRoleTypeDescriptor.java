 ...
 * Schema.
 * $Id: GroupRoleTypeDescriptor.java,v 1.1 2006/09/08 14:31:54 geymonda Exp $
 */
...
/**
 * Class GroupRoleTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:54 $
 */
public class GroupRoleTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GroupRoleTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "groupRoleType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GroupRoleType target = (GroupRoleType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.GroupRoleTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.GroupRoleType.class;

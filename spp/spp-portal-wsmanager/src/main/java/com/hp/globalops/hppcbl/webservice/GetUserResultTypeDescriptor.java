 ...
 * Schema.
 * $Id: GetUserResultTypeDescriptor.java,v 1.1 2006/09/08 14:32:17 geymonda Exp $
 */
...
/**
 * Class GetUserResultTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:17 $
 */
public class GetUserResultTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GetUserResultTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "getUserResultType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GetUserResultType target = (GetUserResultType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.GetUserResultTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.GetUserResultType.class;

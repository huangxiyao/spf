 ...
 * Schema.
 * $Id: ProfileIdentityTypeDescriptor.java,v 1.1 2006/09/08 14:32:08 geymonda Exp $
 */
...
/**
 * Class ProfileIdentityTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:08 $
 */
public class ProfileIdentityTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProfileIdentityTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "profileIdentityType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ProfileIdentityType target = (ProfileIdentityType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.ProfileIdentityTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.ProfileIdentityType.class;

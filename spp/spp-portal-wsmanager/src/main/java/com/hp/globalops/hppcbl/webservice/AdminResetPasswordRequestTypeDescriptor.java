 ...
 * Schema.
 * $Id: AdminResetPasswordRequestTypeDescriptor.java,v 1.1 2006/09/08 14:31:50 geymonda Exp $
 */
...
/**
 * Class AdminResetPasswordRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:50 $
 */
public class AdminResetPasswordRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AdminResetPasswordRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "adminResetPasswordRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AdminResetPasswordRequestType target = (AdminResetPasswordRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.AdminResetPasswordRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.AdminResetPasswordRequestType.class;

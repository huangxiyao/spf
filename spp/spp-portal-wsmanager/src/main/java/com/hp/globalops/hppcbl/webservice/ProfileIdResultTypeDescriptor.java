 ...
 * Schema.
 * $Id: ProfileIdResultTypeDescriptor.java,v 1.1 2006/09/08 14:32:04 geymonda Exp $
 */
...
/**
 * Class ProfileIdResultTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:04 $
 */
public class ProfileIdResultTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProfileIdResultTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "profileIdResultType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ProfileIdResultType target = (ProfileIdResultType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.ProfileIdResultTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.ProfileIdResultType.class;

 ...
 * Schema.
 * $Id: CheckAuthorityRequestTypeDescriptor.java,v 1.1 2006/09/08 14:32:19 geymonda Exp $
 */
...
/**
 * Class CheckAuthorityRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:19 $
 */
public class CheckAuthorityRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CheckAuthorityRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "checkAuthorityRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CheckAuthorityRequestType target = (CheckAuthorityRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.CheckAuthorityRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.CheckAuthorityRequestType.class;

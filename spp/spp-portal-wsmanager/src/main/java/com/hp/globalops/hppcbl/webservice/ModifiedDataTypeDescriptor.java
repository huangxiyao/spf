 ...
 * Schema.
 * $Id: ModifiedDataTypeDescriptor.java,v 1.1 2006/09/08 14:32:08 geymonda Exp $
 */
...
/**
 * Class ModifiedDataTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:08 $
 */
public class ModifiedDataTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ModifiedDataTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "modifiedDataType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ModifiedDataType target = (ModifiedDataType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.ModifiedDataTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.ModifiedDataType.class;

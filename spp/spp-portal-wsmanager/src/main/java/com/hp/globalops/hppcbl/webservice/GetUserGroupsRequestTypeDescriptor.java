 ...
 * Schema.
 * $Id: GetUserGroupsRequestTypeDescriptor.java,v 1.1 2006/09/08 14:32:07 geymonda Exp $
 */
...
/**
 * Class GetUserGroupsRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:07 $
 */
public class GetUserGroupsRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GetUserGroupsRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "getUserGroupsRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GetUserGroupsRequestType target = (GetUserGroupsRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.GetUserGroupsRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.GetUserGroupsRequestType.class;

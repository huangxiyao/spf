 ...
 * Schema.
 * $Id: GetMembersOfGroupRequestTypeDescriptor.java,v 1.1 2006/09/08 14:32:04 geymonda Exp $
 */
...
/**
 * Class GetMembersOfGroupRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:04 $
 */
public class GetMembersOfGroupRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GetMembersOfGroupRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "getMembersOfGroupRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GetMembersOfGroupRequestType target = (GetMembersOfGroupRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.GetMembersOfGroupRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.GetMembersOfGroupRequestType.class;

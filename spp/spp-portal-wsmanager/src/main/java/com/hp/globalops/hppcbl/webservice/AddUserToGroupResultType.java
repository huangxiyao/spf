 ...
 * Schema.
 * $Id: AddUserToGroupResultType.java,v 1.1 2006/09/08 14:32:09 geymonda Exp $
 */
...
/**
 * Class AddUserToGroupResultType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:09 $
 */
public class AddUserToGroupResultType implements java.io.Serializable {
    ...
    public AddUserToGroupResultType() 
     {
        super();
    } //-- com.hp.globalops.hppcbl.webservice.AddUserToGroupResultType()

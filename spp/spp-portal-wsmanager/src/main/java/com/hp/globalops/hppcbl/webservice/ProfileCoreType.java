 ...
 * Schema.
 * $Id: ProfileCoreType.java,v 1.1 2006/09/08 14:32:13 geymonda Exp $
 */
...
/**
 * Class ProfileCoreType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:13 $
 */
public class ProfileCoreType implements java.io.Serializable {
    ...
    public ProfileCoreType() 
     {
        super();
    } //-- com.hp.globalops.hppcbl.webservice.ProfileCoreType()

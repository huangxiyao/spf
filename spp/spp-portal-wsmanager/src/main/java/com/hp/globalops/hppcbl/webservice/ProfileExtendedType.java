 ...
 * Schema.
 * $Id: ProfileExtendedType.java,v 1.1 2006/09/08 14:32:11 geymonda Exp $
 */
...
/**
 * Class ProfileExtendedType.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:11 $
 */
public class ProfileExtendedType implements java.io.Serializable {
    ...
    public ProfileExtendedType() 
     {
        super();
    } //-- com.hp.globalops.hppcbl.webservice.ProfileExtendedType()

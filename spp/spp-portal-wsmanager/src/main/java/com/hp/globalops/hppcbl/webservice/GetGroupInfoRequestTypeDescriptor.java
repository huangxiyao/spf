 ...
 * Schema.
 * $Id: GetGroupInfoRequestTypeDescriptor.java,v 1.1 2006/09/08 14:32:20 geymonda Exp $
 */
...
/**
 * Class GetGroupInfoRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:20 $
 */
public class GetGroupInfoRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GetGroupInfoRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "getGroupInfoRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GetGroupInfoRequestType target = (GetGroupInfoRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.GetGroupInfoRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.GetGroupInfoRequestType.class;

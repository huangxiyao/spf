 ...
 * Schema.
 * $Id: AdminCreateUserRequestTypeDescriptor.java,v 1.1 2006/09/08 14:31:49 geymonda Exp $
 */
...
/**
 * Class AdminCreateUserRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:49 $
 */
public class AdminCreateUserRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AdminCreateUserRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "adminCreateUserRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AdminCreateUserRequestType target = (AdminCreateUserRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.AdminCreateUserRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.AdminCreateUserRequestType.class;

 ...
 * Schema.
 * $Id: MigrateUserRequestTypeDescriptor.java,v 1.1 2006/09/08 14:32:14 geymonda Exp $
 */
...
/**
 * Class MigrateUserRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:32:14 $
 */
public class MigrateUserRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MigrateUserRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "migrateUserRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                MigrateUserRequestType target = (MigrateUserRequestType) object;
        ...
        //-- _applicationRefId
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_applicationRefId", "applicationRefId", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    MigrateUserRequestType target = (MigrateUserRequestType) object;
                    target.setApplicationRefId( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _applicationRefId
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.MigrateUserRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.MigrateUserRequestType.class;

 ...
 * Schema.
 * $Id: LoginRequestTypeDescriptor.java,v 1.1 2006/09/08 14:31:55 geymonda Exp $
 */
...
/**
 * Class LoginRequestTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2006/09/08 14:31:55 $
 */
public class LoginRequestTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LoginRequestTypeDescriptor() 
     {
        super();
        nsURI = "http://hppws.globalops.hp.com/PassportService";
        xmlName = "loginRequestType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LoginRequestType target = (LoginRequestType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.hp.globalops.hppcbl.webservice.LoginRequestTypeDescriptor()
    ...
    {
        return com.hp.globalops.hppcbl.webservice.LoginRequestType.class;

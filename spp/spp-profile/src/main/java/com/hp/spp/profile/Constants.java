...
public interface Constants {
	...
	/**
	 * the name of the user name (SM_USERDN) in the user profile map
	 */
	...
	/**
	 * the HPP header SM_USERDN. SM_USERDN contains the login ID of the user, regardless of whether
	 * the user logged in using login ID or email address. SM_USER would contain the value the user
	 * signed in with, therefore we use SM_USERDN header.
	 */

...
/**
 * JUnit tests for the com.hp.spp.groups.expressions.Conjunction class.
 * @author PBRETHER
 *
 */
public class ConjunctionTest extends TestCase {
	...
	/**
	 * Tests Conjunction with two false expressions
	...
	public void testTwoFalseExpressions() throws Exception {
		...
		Conjunction twoFalse = new Conjunction();

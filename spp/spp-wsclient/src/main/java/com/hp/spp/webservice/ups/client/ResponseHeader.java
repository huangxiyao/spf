...
public class ResponseHeader  implements java.io.Serializable {
    ...
    /**
     * Gets the requestDate value for this ResponseHeader.
     * 
     * @return requestDate
     */
    ...
    /**
     * Sets the requestDate value for this ResponseHeader.
     * 
     * @param requestDate
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://UPSWeb.hp.com/Services", "ResponseHeader"));

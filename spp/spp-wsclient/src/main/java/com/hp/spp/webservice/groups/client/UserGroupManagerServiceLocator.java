...
public class UserGroupManagerServiceLocator extends org.apache.axis.client.Service implements com.hp.spp.webservice.groups.client.UserGroupManagerService {
    ...
    private java.lang.String UserGroupManager_address = "http://localhost:27005/spp-services-web/services/UserGroupManager";
    ...
    public com.hp.spp.webservice.groups.client.UserGroupManager_PortType getUserGroupManager(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hp.spp.webservice.groups.client.UserGroupManagerSoapBindingStub _stub = new com.hp.spp.webservice.groups.client.UserGroupManagerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hp.spp.webservice.groups.client.UserGroupManager_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hp.spp.webservice.groups.client.UserGroupManagerSoapBindingStub _stub = new com.hp.spp.webservice.groups.client.UserGroupManagerSoapBindingStub(new java.net.URL(UserGroupManager_address), this);
                _stub.setPortName(getUserGroupManagerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:27005/spp-services-web/services/UserGroupManager", "UserGroupManagerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:27005/spp-services-web/services/UserGroupManager", "UserGroupManager"));
        }

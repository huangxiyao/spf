 ...
 * time recorder will automatically create a logger "TIME.com.hp.spp.perf.TimeRecorder.UPS".
 *
...
public class TimeRecorder {
	...
	public String getRecordedDataAsString() {
		...
		List operations = getThreadOperationList(mMainThread);
	...
	// This method should normally be private. It is package private as it's also used in test classes.
	OperationData getOperationData(Operation operation) {
	...
	// This method should normally be private. It is package private as it's also used in test classes.
	List<OperationData> getOperationDataList() {

...
public class AnyType2AnyTypeMap  implements java.io.Serializable {
    private com.hp.it.spf.user.group.stub.AnyType2AnyTypeMapEntry[] entry;

    public AnyType2AnyTypeMap() {
    }

    public AnyType2AnyTypeMap(
           com.hp.it.spf.user.group.stub.AnyType2AnyTypeMapEntry[] entry) {
           this.entry = entry;
    }
     ...
     * @return entry
     */
    public com.hp.it.spf.user.group.stub.AnyType2AnyTypeMapEntry[] getEntry() {
        return entry;
    }
     ...
     * @param entry
     */
    public void setEntry(com.hp.it.spf.user.group.stub.AnyType2AnyTypeMapEntry[] entry) {
        this.entry = entry;
    }

    public com.hp.it.spf.user.group.stub.AnyType2AnyTypeMapEntry getEntry(int i) {
        return this.entry[i];
    }

    public void setEntry(int i, com.hp.it.spf.user.group.stub.AnyType2AnyTypeMapEntry _value) {
        this.entry[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.asl.ugs.runtime.hp.com", "anyType2anyTypeMap"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entry");
        elemField.setXmlName(new javax.xml.namespace.QName("http://service.asl.ugs.runtime.hp.com", "entry"));

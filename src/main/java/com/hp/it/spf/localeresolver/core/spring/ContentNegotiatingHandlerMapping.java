...
package com.hp.it.spf.localeresolver.core.spring;
...
import com.hp.it.spf.localeresolver.core.http.ContentNegotiator;

/**
 * A handler mapping that in addition to mapping based solely on URL, also maps
 * based on specified
 * {@link com.hp.it.spf.localeresolver.core.http.ContentNegotiator ContentNegotiators}.
 * 
 * @author Quintin May
...
public class ContentNegotiatingHandlerMapping extends SimpleUrlHandlerMapping {
     ...
     * {@link com.hp.it.spf.localeresolver.core.http.ContentNegotiator#acceptable(HttpServletRequest)}

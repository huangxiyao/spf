...
public class AdmissionControlFilter implements Filter {
    ...
    public void doFilter(ServletRequest srequest, ServletResponse sresponse,
        ...
        // This and other System.out.println's below to be replaced with Log4J
        // or similar debug logging at a future date - DSJ 2006/11/29
        //
        // System.out.println("-- Enter AdmissionControlFilter.doFilter");
        ...
        if ((srequest == null) || (sresponse == null)) {
            // System.out.println("-- Exit 1 AdmissionControlFilter.doFilter");
            chain.doFilter(srequest, sresponse);
            return;
        }
        if (!(srequest instanceof HttpServletRequest)
                || !(sresponse instanceof HttpServletResponse)) {
            // System.out.println("-- Exit 2 AdmissionControlFilter.doFilter");
            chain.doFilter(srequest, sresponse);
            return;
        }
        ...
        // System.out.println("--- hostname used by client: [" + hostname +
        // "]");
        // System.out.println("--- pool used by client: [" + poolID + "]");
        if ((hostname == null) || (poolID == null)) {
            // System.out.println("-- Exit 3 AdmissionControlFilter.doFilter");
        ...
        // System.out.println("--- pool hostname: [" + poolHostname + "]");
        // System.out.println("--- this site hostname: [" + thisSiteHostname +
        // "]");
        if ((poolHostname == null) || (thisSiteHostname == null)) {
            // System.out.println("-- Exit 4 AdmissionControlFilter.doFilter");
            chain.doFilter(request, response);
            return;
        }
        ...
        // System.out.println("--- staff user: [" + staffUser + "]");
        // System.out.println("--- previously admitted: [" + admitted + "]");
        // System.out.println("--- used pool hostname: [" + usedPoolHostname +
        // "]");
        // System.out.println("--- used this site hostname: [" +
        // usedThisSiteHostname + "]");
        // System.out.println("--- used other site hostname: [" +
        ...
        if (!staffUser && (closed || (closing && !admitted))) {
            if (poolHostname != null) {
                ...
                // AdmissionControlFilter.doFilter");
        ...
        // System.out.println("-- Exit 8 AdmissionControlFilter.doFilter");
    ...
    public void init(FilterConfig fconfig) throws ServletException {
        ...
        // or similar debug logging at a future date - DSJ 2006/11/29
        //
        // System.out.println("-- Enter AdmissionControlFilter.init");
        ...
        // System.out.println("-- Exit AdmissionControlFilter.init");
                ...
                if (values != null)
                    for (i = 0; i < values.length; i++) {
                        ...
                        // redirect will go to.
                            ...
                            value = this.replaceHostAndPort(value, 
                                        newHostname + port);
                        }
    ...
    private boolean clientIsStaffUser(HttpServletRequest request, String poolID) {
        ...
        // System.out.println("--- isStaffUser 1");
        ...
        // System.out.println("--- isStaffUser 2");
        if (session != null) {
        ...
        // System.out.println("--- isStaffUser 3");
        if (ip != null) {
        ...
        // System.out.println("--- isStaffUser 4");
        ...
        // end user.
        // System.out.println("--- isStaffUser 5");
        return false;

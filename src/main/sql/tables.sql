...
CREATE TABLE PORTLET_USER_WINDOW_PREFERENCE (ID NUMBER(19) NOT NULL, TYPE VARCHAR2(255) NULL, PREFERENCENAME VARCHAR2(255) NULL, PREFERENCEVALUE VARCHAR2(255) NULL, PORTLET_USER_WINDOW_ID NUMBER(19) NOT NULL, PRIMARY KEY (ID))

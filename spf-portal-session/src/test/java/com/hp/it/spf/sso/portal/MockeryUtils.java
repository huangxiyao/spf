        ...
        context.checking(new Expectations() {
            {
                ...
                allowing(request).getHeader("Account_Header");will(returnValue("=?UTF-8?B??="));
                allowing(request).getHeader("Account_HomeHeader");will(returnValue("=?UTF-8?B??="));
                allowing(request).getHeader("Account_BusHeader");will(returnValue(""));

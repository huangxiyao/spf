...
/**
 * This class is a copy of org.apache.ibatis.jdbc.ScriptRunner.
 * It was renamed to explicitly indicate that it comes from IBatis. The reason to copy
 * this class is to avoid adding new dependency to Vignette-related project.
 * This class is package private to make sure it is not used outside of this package
 * and so it can be replaced with another implementation if needed.
 * <p>
 * RuntimeSqlException class was added as an inner class while in IBatis it remains
 * a separate class.
 * <p>
 * Both of these classes are under Apache License 2.0 - http://www.apache.org/licenses/LICENSE-2.0
 */
class IBatisScriptRunner
{

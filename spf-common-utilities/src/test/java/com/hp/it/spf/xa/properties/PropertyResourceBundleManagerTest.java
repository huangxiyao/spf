...
public class PropertyResourceBundleManagerTest extends TestCase {
    ...
    public void testGetBundleStringLocale() {
        ...
        System.out.println("2.2: Find properties for locale zh-CN -- but because zh is already in cache, make sure that one is returned.");
        ...
        System.out.println("2.3: Repeat 2.2 but force time to expire and make sure zh-CN is now returned.");

...
import com.hp.it.spf.openportal.portletcontainer.admin.registry.database.PortletWindowPreferenceRegistryContextDBImpl;
...
/**
 * create database implementation for PortletAppRegistryContext, PortletWindowRegistryContext, PortletWindowPreferenceRegistryContext
 * 
...
public class PortletRegistryContextDBImpl implements PortletRegistryContext {
	...
	/**
	 * create database implementation for PortletAppRegistryContext,
	 * PortletWindowRegistryContext, PortletWindowPreferenceRegistryContext
	 * 
		...
		synchronized (syncObject) {
			if (!PortletRegistryCache.readPortletAppRegistryCache()
				...
				PortletRegistryCache
						.setPortletAppRegistryContext(portletAppRegistryContext);
				PortletRegistryCache.refreshPortletAppRegistryCache(false);
			}
			portletAppRegistryContext = PortletRegistryCache
			...
			if (!PortletRegistryCache.readPortletWindowRegistryCache()
				...
				PortletRegistryCache
						.setPortletWindowRegistryContext(portletWindowRegistryContext);
				PortletRegistryCache.refreshPortletWindowRegistryCache(false);
			}
			portletWindowRegistryContext = PortletRegistryCache
					.getPortletWindowRegistryContext();
			if (!PortletRegistryCache
					.readPortletWindowPreferenceRegistryCache()
					|| PortletRegistryCache
							.getPortletWindowPreferenceRegistryContext() == null) {
				...
				PortletRegistryCache
						.refreshPortletWindowPreferenceRegistryCache(false);
			}
			portletWindowPreferenceRegistryContext = PortletRegistryCache
	...
	public String getDescription(String portletName, String desiredLocale)
			throws PortletRegistryException {
		return portletAppRegistryContext.getDescription(portletName,
				desiredLocale);
	}

	public Map getSupportedModes(String portletName)
			throws PortletRegistryException {
	...
	public String getShortTitle(String portletName, String desiredLocale)
			throws PortletRegistryException {
		return portletAppRegistryContext.getShortTitle(portletName,
				desiredLocale);
	}
	...
	public List getKeywords(String portletName, String desiredLocale)
		...
		return portletAppRegistryContext
				.getKeywords(portletName, desiredLocale);
	}

	public String getDisplayName(String portletName, String desiredLocale)
			throws PortletRegistryException {
		return portletAppRegistryContext.getDisplayName(portletName,
				desiredLocale);
	}
	...
	public Map getUserInfoMap(String portletName)
			throws PortletRegistryException {
	...
	public List getVisiblePortletWindows(PortletType portletType)
			throws PortletRegistryException {
		return portletWindowRegistryContext
				.getVisiblePortletWindows(portletType);
	}
	...
	public Integer getRowNumber(String portletWindowName)
			throws PortletRegistryException {
		return portletWindowRegistryContext.getRowNumber(portletWindowName);
	}

	public String getWidth(String portletWindowName)
			throws PortletRegistryException {
		return portletWindowRegistryContext.getWidth(portletWindowName);
	}

	public void setWidth(String portletWindowName, String width)
			throws PortletRegistryException {
		portletWindowRegistryContext.setWidth(portletWindowName, width);
	}

	public EntityID getEntityId(String portletWindowName)
			throws PortletRegistryException {
	...
	public String getPortletWindowTitle(String portletWindowName)
			throws PortletRegistryException {
		return portletWindowRegistryContext
				.getPortletWindowTitle(portletWindowName);
	}

	public void setPortletWindowTitle(String portletWindowName, String title)
			throws PortletRegistryException {
		portletWindowRegistryContext.setPortletWindowTitle(portletWindowName,
				title);
	}

	public void createPortletWindow(String portletName, String portletWindowName)
			throws PortletRegistryException {
		portletWindowRegistryContext.createPortletWindow(portletName,
				portletWindowName);
	}

	public void createPortletWindow(String portletName,
			String portletWindowName, String title, String locale)
			throws PortletRegistryException {
		portletWindowRegistryContext.createPortletWindow(portletName,
				portletWindowName, title, locale);
		Map exisitingPreferences = getPreferences(portletName,
				PortletRegistryContext.USER_NAME_DEFAULT);
		savePreferences(portletName, portletWindowName,
				PortletRegistryContext.USER_NAME_DEFAULT, exisitingPreferences,
				true);
	}
	...
	public void showPortletWindow(String portletWindowName, boolean visible)
			throws PortletRegistryException {
		portletWindowRegistryContext.showPortletWindow(portletWindowName,
				visible);
	}
	...
	public Map getPreferences(String portletWindowName, String userName)
			throws PortletRegistryException {
		return portletWindowPreferenceRegistryContext.getPreferences(
				portletWindowName, userName);
	}

	public Map getPreferencesReadOnly(String portletWindowName, String userName)
			throws PortletRegistryException {
		return portletWindowPreferenceRegistryContext.getPreferencesReadOnly(
				portletWindowName, userName);
	}
	...
	public void savePreferences(String portletName, String portletWindowName,
		...
		portletWindowPreferenceRegistryContext.savePreferences(portletName,
				portletWindowName, userName, prefMap);
	}

	private void savePreferences(String portletName, String portletWindowName,
			String userName, Map prefMap, boolean readOnly)
			throws PortletRegistryException {
		portletWindowPreferenceRegistryContext.savePreferences(portletName,
				portletWindowName, userName, prefMap, readOnly);
	}
	...
	public List<String> getPortletWindows(String portletName)
			throws PortletRegistryException {
	...
	public String getProducerEntityID(String portletWindowName)
			throws PortletRegistryException {
		return portletWindowRegistryContext
				.getProducerEntityID(portletWindowName);
	}

	public boolean isRemote(String portletWindowName)
			throws PortletRegistryException {

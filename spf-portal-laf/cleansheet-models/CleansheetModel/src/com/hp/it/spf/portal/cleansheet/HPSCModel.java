...
public class HPSCModel {
	...
	/**
	 * <p>The value of this property will be used as the URL to the Omniture metrics collection script that will be inserted at the bottom of the page.  If no value is supplied for this property, the URL to the default Omniture metrics collection script for the current locale will be used.</p> <p>If value is set to null then metrics will be turned off.</p> <p>default: null</p>
	 */

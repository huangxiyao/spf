...
//               element.getParent().setStyle('width','27.5%');
 ...
 //              this.setStyle('width','45%');
	...
	enter: function(event, element){
	    ...
	    if (event.type=='click')
	    event.stop();
		wimage.set({'src':'http://www8.hp.com/us/en/images/i/country_selector.png'});
		//pathArray = window.location.pathname.split( '/' );
		//wimage.set({'src': '/' + pathArray[1] + '/' + pathArray[2] + '/' +'/in/en/images/i/country_selector_462697.png'});

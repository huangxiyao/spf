 ...
 * This represents the data to/from the CMPND_ATTR_SMPL_ATTR table.
 *
 * @author CAS Generator v1.0.0
 */
public class CmpndAttrSmplAttr {

    private CmpndAttrSmplAttrKey key;
    private String crtUserId;
    private Date crtTs;
    
    /**
	 * Sets the primary key for the CMPND_ATTR_SMPL_ATTR table.
	 * @param key the primary key - cannot be null
	 */
    public void setKey(CmpndAttrSmplAttrKey key) {
        this.key = key;
    }

    /**
	 * Returns the primary key for the CMPND_ATTR_SMPL_ATTR table.
	 * @return key.
	 */
    public CmpndAttrSmplAttrKey getKey() {
        return key;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CmpndAttrSmplAttr other = (CmpndAttrSmplAttr) obj;
        if (key == null) {
            if (other.key != null)
                return false;
